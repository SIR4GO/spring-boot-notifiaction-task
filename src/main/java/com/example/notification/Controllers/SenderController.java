...
public class SenderController  {
    ...
    public  Map<String, String> existSender(@RequestBody Map<String, ?> inputs) throws Exception {

        String message = senderServiceImp.existSender((String) inputs.get("token") );
        HashMap<String, String> cardinality = new HashMap<>();
        cardinality.put("message", message);
